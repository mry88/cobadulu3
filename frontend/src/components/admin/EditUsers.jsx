            ...
            <div className="bg-gray-800 p-8 rounded-lg shadow-md w-96">
                <StyledEditUser className="flex w-[100%] h-[100%] items-center justify-center">
                    <StyledForm onSubmit={handleUpdateUser} className="w-[100%] h-[100%]">
                        ...
                        <PrimaryButton type="submit" className="w-full text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-1 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm text-center">
